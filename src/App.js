    ...
    <div>
      ...
      <section aria-labelledby="modifies" className="py-6">
        <div className="max-w-md px-4 mx-auto">
          ...
          <div class="flex justify-between font-mono p-3 bg-white border-4 border-black border-b-0">
          ...
          <div class="flex justify-between font-mono p-3 bg-white border-4 border-black">
      ...
      >
        <div className="max-w-md px-4 mx-auto">
          ...
          <p className="mb-4 text-justify">
            This setting modify the original image, so:
          </p>
